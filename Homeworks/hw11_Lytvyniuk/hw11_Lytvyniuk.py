...
while start:
    ...
    for i in range(rounds):
        ...
        player1_choice = ""
        player2_choice = ""
        while player1_choice != 'rock' and player1_choice != 'scissors' and player1_choice != 'paper':
            player1_choice = str(input(f"{player1_name}, enter [rock], [paper], [scissors]: "))
        if game_type == "pvp":
            while player2_choice != "rock" and player2_choice != "scissors" and player2_choice != "paper":
                player2_choice = str(input(f"{player2_name}, enter [rock], [paper], [scissors]: "))
        else:
